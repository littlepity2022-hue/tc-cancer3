...
prep_data = {
    "1. 前置作業": {
        "步驟": ["1.1 進入化療室之前，需先關閉UV燈。", "1.2 設定當日化療標籤貼紙上列印的藥師。", "1.3 打開無菌通風開關，打開生物安全櫃開關 (至少使用前30分鐘開機運轉)。", "1.4 登記化療調配室的溫濕度、生物操作檯數據、壓差表。", "1.5 開啟當日作業所需的化療系統。", "1.5 將漏液機裝上管線並進行校正 (每次100ml)。", "1.6 調配前後皆須以紗布沾溼75％酒精進行清潔 (由上而下、由內而外)。"],
    ...
    "8. 例行性業務": {
        "步驟": ["8.1 每月做落菌試驗 (培養皿放置生物安全櫃一小時)。", "8.2 每週一進行耗材請領。", "8.3 遇缺藥時進行緊急請領。", "8.4 每週六進行環境清潔 (75%酒精擦拭、更換防塵墊、處理細胞毒性廢棄物)。", "8.5 每週三下午進行藥物盤點。", "8.6 每週二、五進行藥物撥補。", "8.7 每週六至供應中心領回消毒後的手術衣與無菌治療巾。", "8.8 每月10日前完成業務量統計。"],
...
# 3. 週六單人流程核心
    ...
    sat_steps = [
        ...
        "6 通常最後一批會等到11:15左右入內開始調配在此之前須完成審核與雙人核對",
        "7 進入抽藥，清掃完畢可打給3850預約傳送時間",
        "8 發藥、封包、等傳送、登載每日業務報表",
        "9 拆漏液機管線到紅色袋子",
        "10拿下冰箱上的所有表單進行檢查登記",
        "11 收拾、關機關燈開UV燈簽退"
    ]
