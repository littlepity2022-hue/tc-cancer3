...
audit_data = {
    ...
    "5. 藥物之運送": {
        ...
        "注意事項": "• 調配完成後經由 PASS BOX 運送。\n• 系統自動通知傳送，由傳送人員以化療專用推車進行簽收運送。(His 5化療傳送)"
    },
    "6. 提供相關之藥物諮詢": {
        "步驟": ["6.1 回覆化療相關之諮詢電話。"],
        "注意事項": ""
...
# ==========================================
# ⚡ 每日核心流程速查（完全聚焦日常動線、口訣）
# ==========================================
elif page == "⚡ 週六單人流程速查":
    st.title("⚡ 週六單人流程精簡速查 (備忘口訣)")
    st.markdown("本頁面依據現場實務精簡之 12 項核心動作編製，供開機、調配與收尾快速核對。")
    st.divider()
